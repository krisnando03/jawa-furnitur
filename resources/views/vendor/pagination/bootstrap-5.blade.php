...
<nav class="d-flex justify-items-center justify-content-between">
    ...
    <div class="d-none d-sm-block"> {{-- Mengubah dari flex row menjadi block untuk susunan vertikal --}}
        <div class="text-sm-center mb-2"> {{-- Pusatkan teks "Showing..." dan beri margin bawah --}}
        ...
        <div class="d-flex justify-content-sm-center"> {{-- Pusatkan navigasi halaman --}}
            <ul class="pagination">
                {{-- Previous Page Link --}}
                @if ($paginator->onFirstPage())
